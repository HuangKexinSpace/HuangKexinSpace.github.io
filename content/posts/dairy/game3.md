...
# Done
- 学了下midjourney的使用，设定了人物立绘的关键词，根据两种风格（像素风、某插画风）生成了几张人物立绘，还算不错，感觉可以直接用了。尝试了垫图，效果页还不错。大概最多生成3-5种风格就需要选定一种了，不过目前对这个插画风生的图非常满意hhh。
...
# 美术风格参考
## 像素风
![alt text](attachments/25122701.png)
- pixel art
- 8-bit game

## 插画风1
![alt text](attachments/25122702.png)
🪄Prompt解析：
风格词：扁平插画、扁平人物
艺术风格：极简艺术、卡通、高饱和度
画面描述:看着镜头、近距离头像
